...
contract NoopVault is ERC20, ERC20Detailed, IVault, Controllable {
    ...
    event Deposit(address indexed beneficiary, uint256 amount, uint16 referral);
    ...
    constructor(
        ...
        ERC20Detailed(
            string(
                abi.encodePacked("Chad_", ERC20Detailed(_underlying).name())
            ),
            string(
                abi.encodePacked("chad", ERC20Detailed(_underlying).symbol())
            ),
    ...
    function depositFor(
        ...
        _deposit(amount, msg.sender, holder, referral);
    }
    ...
    function withdraw(uint256 numberOfShares) external {
        ...
        withdrawals[msg.sender] = withdrawals[msg.sender].add(
    ...
    function _deposit(
        ...
        emit Deposit(beneficiary, amount, referral);
    }
}
